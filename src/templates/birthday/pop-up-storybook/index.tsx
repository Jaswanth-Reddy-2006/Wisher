...
export const PopUpStorybook: React.FC<TemplateProps> = ({ data, isPreview = false }) => {
  ...
  return (
    <div className={`storybook-viewport ${isOpen ? 'scrollable' : ''}`}>
      ...
      <div className="w-full h-[100dvh] flex flex-col items-center justify-center relative shrink-0 overflow-hidden">
        ...
        {isOpen && (
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-xs font-bold uppercase tracking-widest text-[#5c3a21] animate-bounce select-none pointer-events-none z-30">
            <span className="text-[10px]">Read Story</span>
      ...
      {isOpen && (
        <div className="w-full bg-[#fdfaf2] text-[#5c3a21] border-t border-[#5c3a21]/15">
