...
const BookCanvas = ({ active, setActive, data, navigate }) => {
                ...
                <div className="card1">
                    <div className="cover-text-wrapper">
                        <h4 className="username">
                            Dear {data?.targetName || "Navya"}<span className="underline"></span>
                        </h4>
                    ...
                    <div className="userImg">
                        <img src="/assets/anime_girl_portrait.png" alt="Recipient's Photo" />
                    </div>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text italic">
                            <article style={{ marginBottom: '8px' }}>Happy Birthday, {data?.targetName || "Navya"} ❤️</article>
                            <article style={{ marginBottom: '10px' }}>{data?.message || "From the moment we met, something in my life shifted—like the universe quietly guiding me toward someone meant for me."}</article>
                            {data?.extraMessage && <article style={{ marginBottom: '10px' }}>{data.extraMessage}</article>}
                        </div>
                        ...
                        <p className="signature" onClick={() => navigate('love-letter')} style={{ cursor: 'pointer' }}>
                            Your Best Friend, {data?.senderName || "Arjun"} <br/>
                            <span style={{ fontSize: '1rem', color: 'blue' }}>Click to open Envelope ➔</span>
                        </p>
                    </div>
                </div>
            </div>
