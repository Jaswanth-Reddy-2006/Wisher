...
const Home = ({ data, navigate }) => {
    ...
    // Format date for pill
    const dateObj = new Date(data.date);
    const datetxt = dateObj.toLocaleDateString('en-GB', { day: 'numeric', month: 'short' });
        ...
        const delayTimeout = setTimeout(function () {
            const interval = setInterval(function () {
                if (currentIndex < charArrDate.length) {
                    typed += charArrDate[currentIndex];
                    setTypedText(typed);
                    currentIndex++;
                } else {
    ...
    return (
        <div id="wrapper">
            <div className="flag__birthday">
                <img src="/assets/romantic/1.png" alt="" width="350" className="flag__left" />
                <img src="/assets/romantic/1.png" alt="" width="350" className="flag__right" />
            </div>
            ...
            <div className="content">
                <div className="left">
                    <div className="title">
                        ...
                        <div className="hat">
                            <img src="/assets/romantic/hat.png" alt="" width="130" />
                        </div>
                    </div>
                    ...
                    <div className="btn flex md:gap-2 md:flex-row flex-col">
                        <button onClick={() => SetActive(!Active)} id="btn__letter">
                            <div className="mail flex items-center justify-center gap-2 md:text-[1rem] text-sm">
                                ...
                                Click Here {data.targetName}
                            </div>
                        </button>
                        <div id="FromRexon" style={{ cursor: 'pointer' }} onClick={() => navigate('love-letter')}>
                            <div className="mail flex items-center gap-2 md:text-[1rem] text-sm">
                ...
                <div className="right">
                    <div className="box__account">
                        <div className="image">
                            <img src="/assets/anime_girl_portrait.png" alt="" />
                        </div>
                        <div className="name">
                            <i className="fa-solid fa-heart"></i>
                            <span>Dear {data.targetName}</span>
                            <i className="fa-solid fa-heart"></i>
                        </div>
                        <div className="balloon_one">
                            <img width="100px" src="/assets/romantic/balloon1.png" alt="" />
                        </div>
                        <div className="balloon_two">
                            <img width="100px" src="/assets/romantic/balloon2.png" alt="" />
                        </div>
                    </div>
            ...
            <div className="decorate_flower--one" style={{ "--t": "15s" }}>
                <img width="20" src="/assets/romantic/decorate_flower.png" alt="" />
            </div>
            ...
            <div className="decorate_bottom">
                <img src="/assets/romantic/decorate.png" alt="" width="100" />
            </div>

            <div className="smiley__icon">
                <img src="/assets/romantic/smiley_icon.png" alt="" width="100" />
            </div>

            <BookCanvas active={Active} setActive={SetActive} data={data} navigate={navigate} />
